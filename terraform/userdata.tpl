...
sudo docker run -d --net icorp-network -p 49001:8080 -v $PWD/jenkins:/var/jenkins_home:z --name jenkins -t jenkins/jenkins:lts
sudo docker run -d --net icorp-network -p 27017-27019:27017-27019 --name mongodb mongo:latest
